...
[![Africa](https://img.shields.io/badge/Long-Africa-%238B0000?style=for-the-badge&logo=data:image/svg+xml;base64,)](https://github.com/nzaghaventures)
[![Permanent Capital](https://img.shields.io/badge/Permanent-Capital-%23A52A2A?style=for-the-badge)](https://github.com/nzaghaventures)
[![Based in Biafra](https://img.shields.io/badge/Based%20in-Biafra-%23FCCC52?style=for-the-badge)](https://github.com/nzaghaventures)
...
**Nzagha is Long Africa, Permanent Capital Based in Biafra.**

We build, buy, and invest for the African century.

Nzagha is a Long Africa permanent capital vehicle for investing and re‑investing on the continent. We are neither a classic VC nor a venture studio; we are a **flexible operating conglomerate organization** that invests, builds, co-creates, acquires, and scales new ventures. We're building a diversified portfolio of high-growth African companies and products that complement and reinforce each other's value.

### Our Unique Value Proposition

🌍 **Invest Broadly in Africa's Future** — For our investors and partners, Nzagha provides a unique opportunity to invest broadly in Africa's future, help propel its growth, solve critically important problems of the 21st century, work with great African entrepreneurs, and build generation-defining value.

🤝 **Active, Not Passive** — We do not invest passively, nor look at businesses in isolation. We actively support and sometimes help operate our portfolio. We finance and build connective tissue between and adjacent to our portfolio companies. And we actively leverage the assets and networks across our portfolio to give our ventures an unfair advantage.

📈 **Long-Term Compounding Growth** — Nzagha is focused on long-term compounding growth in Africa and for Africa.
...
**The most important problems and biggest opportunities of the 21st century are in Africa.** To meet them, the continent's entrepreneurs and creatives will make themselves heard. Nzagha exists to identify, support, and build alongside them.
...
- **[Topazdom Technologies Limited](https://topazdom.com)** — Core software and systems development company
...
- **[EkwePay](https://ekwepay.com)** — Offline-first neobanking fintech for financial inclusion
- **[Occano Labs](https://occanolabs.com)** — On-chain consumer music and creative AI software

### Research & Innovation

- **Ikemba Innovation Research Lab** — Applied research exploring emerging technologies and African-first innovation models

### Agriculture, Manufacturing & Industrial Operations

- **[Nzagha Farms](https://nzagha.com/farms)** — Agricultural production and agribusiness operations
- **[Nzagha Breweries](https://nzagha.com/breweries)** — Beverage production and brewing operations
- **[Nzagha Block Industry](https://nzagha.com/block-industry)** — Building materials manufacturing
- **[Nzagha Constructions](https://nzagha.com/constructions)** — Construction and infrastructure development

---

## 🎨 Our Values

1. **We bring Africa to the world, and the world to Africa**
2. **We are long-term investors and permanent reinvestors in the African growth story**
3. **Everything we do contributes to African economic, entrepreneurial, and intellectual growth**
4. **We will not contribute to human suffering**
5. **We embrace the new ways of doing business in Africa: transparency, integrity, and long‑term commitment**
...
*Nzagha Ventures Corp — Permanent Capital for the African Century*

---

🧹 *Nzagha: Unity in strength, like the native compound broom — many strands bound together, stronger as one*
